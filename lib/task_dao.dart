...
class Task {
  ...
  Map<String, dynamic> toMap() {
    return {
      ...
      'dueDate': dueDate != null ? dueDate!.millisecondsSinceEpoch : null, // Store due date as milliseconds since epoch
    };
  }
  ...
  factory Task.fromMap(Map<String, dynamic> map) {
    return Task(
      ...
      dueDate: map['dueDate'] != null ? DateTime.fromMillisecondsSinceEpoch(map['dueDate']) : null, // Convert milliseconds to DateTime
    );
  }
}
